...
module.exports = {
    ...
    update_a_task: function(req,res){
        Task.findByIdAndUpdate(req.params._id,{title: req.body.title, description: req.body.description, completed: req.body.completed}, function(err,data){
            if(err){
                res.json(err)
            }
            else{ 
    ...
    delete_a_task: function(req,res){
        Task.findByIdAndDelete({_id: req.params._id}, function(err,data){
            if(err){
                res.json(err)
            }
            else{ 
